...
class CNN:
    ...
    def train(self,X:xp.ndarray,Y:xp.ndarray,
              ...
              loss:str='single', multilabel:bool=True,save_path:str=None):
    ...
    #----------------文件外终止，软操作-----------------------------------------------------------------
                    ...
                    if multilabel == 0:
                        ...
                        d_bce = (y_hat_clip - Y_batch) / (y_hat_clip * (1 - y_hat_clip))
                        d_y = y_hat_clip - Y_batch 
                        self.backward(d_bce)
                ...
                if num_batches > 0:
                    ...
                    # 学习率自更新：
                    if len(self.cost_history) > 0 and self.cost_history[-1] >epoch_cost:
